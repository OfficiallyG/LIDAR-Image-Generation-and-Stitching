...
interface.py: this file is the window that is opened on the users laptop. this interfcae is what lets the user view the .ply file and edit/stitch the files.
myLivox360.py: this file ...
sender.py: this file lets the raspberry pi send the resulting .ply file from the lidar to the users laptop.
test_lidar: this file ...
//stitch.py: this file ...
